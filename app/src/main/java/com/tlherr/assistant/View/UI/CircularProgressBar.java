package com.tlherr.assistant.View.UI;
...
public class CircularProgressBar extends View
{
    ...
    public CircularProgressBar(final Context context, final AttributeSet attrs, final int defStyle)
    {
        ...
        try
        {
            final int bgColor = args.getColor(R.styleable.circularProgressBar_bgColor, getResources().getColor(R.color.black));
            final int bgStrokeWidth = args.getDimensionPixelSize(R.styleable.circularProgressBar_bgStrokeWidth,
                    (int) defaultStrokeWidth);

            final int progressColor = args.getColor(R.styleable.circularProgressBar_progressColor, getResources().getColor(R.color.white));
            ...
            this.mDescriptionPaint.setStyle(Style.STROKE);
            this.mDescriptionPaint.setTextAlign(Align.CENTER);
            this.mDescriptionPaint.setTextSize(textSize);
        }
        finally
        {
            args.recycle();
    ...
    public void setmTextTimerDesc(String mTextTimerDesc) {
        this.mTextTimerDesc = mTextTimerDesc;
    }
}
